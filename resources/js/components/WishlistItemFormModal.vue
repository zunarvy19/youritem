...
watch(
    ...
    (open) => {
        ...
        if (props.item) {
            ...
            form.product_url = props.item.product_url ?? '';
        } else {
            form.name = '';
    ...
    [
        {
            value: 'NEED',
            label: 'Need',
            description: 'Essential or replacing something',
        },
...
function clientValidate(): boolean {
    ...
    if (
        form.estimated_price === null ||
        !Number.isInteger(form.estimated_price) ||
        form.estimated_price <= 0
    ) {
        fieldErrors.value.estimated_price = [
...
<template>
    ...
    >
        <form class="space-y-5" novalidate @submit.prevent="submit">
            ...
            <div>
                <label for="item-url" class="field-label">Product link</label>
                <input
                    id="item-url"
                    ...
                    placeholder="https://..."
                />
                <p v-if="fieldErrors.product_url" class="field-error">
                    {{ fieldErrors.product_url[0] }}
                </p>
                <p class="mt-1 text-xs text-neutral-500">
                    The preview will be fetched after the item is saved.
                </p>
            </div>
            ...
            <div>
                <label for="item-category" class="field-label"
                    >Category *</label
                >
                <select
                    id="item-category"
                ...
                <p v-if="fieldErrors.category_id" class="field-error">
            ...
            <fieldset>
                ...
                <div class="grid grid-cols-3 gap-2">
                    ...
                    >
                        ...
                        >
                        <span
                            class="mt-0.5 block text-[11px] text-neutral-500"
                            >{{ option.hint }}</span
                        >
                    </button>
                </div>
            ...
            <fieldset>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    >
                        ...
                        >
                        <span
                            class="mt-0.5 block text-[11px] leading-snug text-neutral-500"
            ...
            <div>
                <label for="item-price" class="field-label"
                ...
                <MoneyInput
                    ...
                    placeholder="0"
                    :aria-invalid="
                        fieldErrors.estimated_price ? 'true' : undefined
                    "
                />
                <p v-if="fieldErrors.estimated_price" class="field-error">
                    {{ fieldErrors.estimated_price[0] }}
                </p>
            </div>

            <div>
                <label for="item-notes" class="field-label">Notes</label>
                <textarea
                    id="item-notes"
                    v-model="form.notes"
                    rows="2"
